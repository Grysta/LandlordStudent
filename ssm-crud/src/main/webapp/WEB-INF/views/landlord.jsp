...
<body background="${APP_PATH }/bg.jpg">
	<div style="margin:0 auto; padding-top: 100px; font-size: 18px;" align="center">
		<p><button class="btn btn-default" type="submit"><a href="landlordLogin">房东登录</a></button></p>
		<p><button class="btn btn-default " type="submit"><a href="landlordRegistPage">房东注册</a></button></p>
	</div>
</body>
</html>